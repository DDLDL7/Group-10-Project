"""
Synthetic dataset generator for the National Electricity Grid Network
Analysis project.

Produces three CSVs in the same spirit as the OpenFlights
airlines/airports/routes trio:
  utilities.csv     (like airlines.csv)
  substations.csv   (like airports.csv)
  lines.csv         (like routes.csv)

Grounded in Ghana's grid (ECG, NEDCo, GRIDCo, VRA) with cross-border
interconnections reflecting the real West African Power Pool (WAPP).
"""
